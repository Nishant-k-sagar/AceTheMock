...
const AddQuestions = () => {
  ...
  return (
    <div>
      <div
        className="p-10 rounded-lg border border-green-700 bg-white hover:scale-105 hover:shadow-sm transition-all cursor-pointer"
      ...
      <Dialog open={openDailog} >
        <DialogContent className="bg-gradient-to-r from-teal-200 to-green-200">
          <DialogHeader>
            <DialogTitle className="text-green-800 text-2xl font-bold" >What model questions are you seeking</DialogTitle>
            <DialogDescription>
              <form onSubmit={onSubmit}>
                <div className="my-3 text-gray-700">
                  ...
                  <div className="mt-7 my-3">
                    <label className="text-green-700 text-lg font-bold">Job Role/job Position</label>
                    <Input
                      className="mt-1"
                      value={jobPosition}
                  ...
                  <div className="my-4">
                  <label className="text-green-700 text-lg font-bold">
                  ...
                  <div className="my-4">
                  <label className="text-green-700 text-lg font-bold">Years of Experience</label>
                    <Input
                      className="mt-1"
                      placeholder="Ex. 5"
                      value={jobExperience}
                ...
                <div className="flex gap-5 justify-end">
                  <Button
                  className="border border-green-700 text-green-700 hover:bg-green-600 hover:text-white"
                    type="button"
                    variant="goast"
