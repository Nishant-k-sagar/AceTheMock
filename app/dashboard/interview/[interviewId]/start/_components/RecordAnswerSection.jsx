    ...
    <div className="flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="md:flex mt-4 md:mt-8 md:gap-5">
        <div className="my-4 md:my-0">
          <Button className="hover:bg-green-600 text-black bg-green-400 border border-green-800"onClick={() => setWebCamEnabled((prev) => !prev)}>
            {webCamEnabled ? "Close WebCam" : "Enable WebCam"}
          </Button>
        </div>
        <Button
          className="hover:bg-green-600 bg-green-400 border border-green-800"
          variant="outline"
